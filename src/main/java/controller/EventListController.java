...
public class EventListController {
    ...
    // ── Actions column: Edit | Clone | QR | Delete ────────────────────────
    ...
    private void setupActionsColumn() {
        colActions.setCellFactory(col -> new TableCell<>() {
            ...
            private final HBox box = new HBox(4, btnEdit, btnClone, btnQR, btnDelete);
    ...
    private void onClone(Event ev) {
        ...
        confirm.setTitle("Clone Event");
        confirm.setHeaderText("Clone \"" + ev.getTitre() + "\"?");
        confirm.setContentText("A draft copy will be created.");
        styleAlert(confirm);
